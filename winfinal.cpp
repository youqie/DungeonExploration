...
winfinal::winfinal(QWidget *parent,bool ismusic) : QMainWindow(parent)
{
    //点击音效
    ...
    ngBtn->move(this->width()*0.5-ngBtn->width()*0.5-5,this->height()*0.5);
    ...
    exitBtn->move(this->width()*0.5-exitBtn->width()*0.5-5,this->height()*0.6);
...
void winfinal::paintEvent(QPaintEvent *)
{
    QPainter painter(this);

    //设置背景
    QPixmap pix;
    pix.load(":/pic/winfinal.png");
